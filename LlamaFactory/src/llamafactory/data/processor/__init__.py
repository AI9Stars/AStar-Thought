...
from .supervised import PackedSupervisedDatasetProcessor, SupervisedDatasetProcessor, AStarThoughtSupervisedDatasetProcessor
...
__all__ = [
    ...
    "AStarThoughtSupervisedDatasetProcessor", ## [NEW] A*-Thought-Latent
]
