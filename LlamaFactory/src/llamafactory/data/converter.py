...
@dataclass
class AStarThoughtDatasetConverter(DatasetConverter):
    def __call__(self, example: dict[str, Any]) -> dict[str, Any]:
        tag_mapping = {
        ...
        ## [NEW] A*-Thought-Latent
        steps = example[self.dataset_attr.steps]
        flags = example[self.dataset_attr.flags]
...
DATASET_CONVERTERS = {
    ...
    "astar-thought-latent": AStarThoughtDatasetConverter, ## [NEW] A*-Thought-Latent
}
