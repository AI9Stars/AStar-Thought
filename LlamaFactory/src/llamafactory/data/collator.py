...
@dataclass
class AStarThoughtMultiModalDataCollatorForSeq2Seq(DataCollatorForSeq2Seq):
    ...
    def __call__(self, features: list[dict[str, Any]]) -> dict[str, "torch.Tensor"]:
        ...
        for feature in features:
            ...
            ## [NEW] A*-Thought-Latent
            latent_spans = feature.pop("latent_spans", None) or []
            batch_latent_spans.append(latent_spans)
        ...
        ## [NEW] A*-Thought-Latent
        features["latent_input_ids"] = features.pop("input_ids")
        features["latent_spans"] = batch_latent_spans

        return features

## [NEW] A*-Thought-Latent
@dataclass
class AStarThoughtSFTDataCollatorWith4DAttentionMask(AStarThoughtMultiModalDataCollatorForSeq2Seq):
    ...
    def __call__(self, features: list[dict[str, Any]]) -> dict[str, "torch.Tensor"]:
        ...
        if self.block_diag_attn and self.attn_implementation != "flash_attention_2":
            ...
            # features["steps_attention_mask"] = prepare_4d_attention_mask(features["steps_attention_mask"], self.compute_dtype)
