...
def load_model(
    ...
    if model_args.astar_thought_latent is True:
        from .modeling.astar_thought.modeling_astar_thought_latent_qwen3_5 import Qwen3_5ForConditionalGeneration
        import transformers.models.qwen3_5.modeling_qwen3_5 as qwen3_5_module
        qwen3_5_module.Qwen3_5ForConditionalGeneration = Qwen3_5ForConditionalGeneration
        ### config
        config.latent_begin_id = tokenizer.convert_tokens_to_ids(model_args.latent_begin_token)
        config.latent_end_id = tokenizer.convert_tokens_to_ids(model_args.latent_end_token)
        config.latent_token_base_id = tokenizer.convert_tokens_to_ids(model_args.latent_tokens.split(",")[0])
        config.num_latent_clusters = len(model_args.latent_tokens.split(","))
        config.structure_weight = model_args.structure_weight
        config.max_latent_len = model_args.max_latent_len
        config.max_latent_count = model_args.max_latent_count
